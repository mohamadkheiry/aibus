...
export type UserKey = { id:string;name:string;keyPrefix:string;canReveal:boolean;isActive:boolean;requestLimit?:number;spendLimitUsd?:number;requestCount:number;spentUsd:number;accessMode:string;modelRules:string[];createdAtUtc:string;lastUsedAtUtc?:string }
